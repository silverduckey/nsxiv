...
static const char *WIN_BG[]   = { "Nsxiv.window.background",    NULL };
static const char *WIN_FG[]   = { "Nsxiv.window.foreground",    NULL };
...
static const char *BAR_FONT[] = { "Nsxiv.bar.font",             NULL };
